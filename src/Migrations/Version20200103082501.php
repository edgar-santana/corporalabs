 ...
 */
final class Version20200103082501 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE `order` CHANGE id_client id_client INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE `order` CHANGE id_client id_client INT NOT NULL');
    }
}
